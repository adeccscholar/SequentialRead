...
int main() {
   ...
   std::cout << "Read Data C++11" << std::endl;
   ...
   std::cout << "Read " << proc.CountOfAddresses() << " rows with C++11" << " in " 
   ...
   std::cout << "Calculated " << proc.CountOfAddresses() << " rows with C++11" << " in "
      << std::setprecision(3) << time / 1000.0 << " ms" << std::endl;
   ...
   func_ende = std::chrono::high_resolution_clock::now();
   time = std::chrono::duration_cast<std::chrono::microseconds>(func_ende - func_start).count();
   std::cout << "Partitioned " << cnt << " rows with C++11" << " in "
      << std::setprecision(3) << time / 1000.0 << " ms" << std::endl;
   getchar();
}
